...
import pws.praktikum119.Mahasiswa.exceptions.NonexistentEntityException;
import pws.praktikum119.Mahasiswa.exceptions.PreexistingEntityException;
...
public class DatamahasiswaJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("pws.praktikum119_Mahasiswa_jar_0.0.1-SNAPSHOTPU");;
